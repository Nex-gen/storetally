...
@section('title', 'Storetally | Admin Dashboard')
									...
									<li>
										<div class="tm-box">
											...
											<div class="thumbnail-gallery">
												<a class="img-thumbnail lightbox" href="{{asset('')}}assets/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
													<img class="img-responsive" width="215" src="{{asset('')}}assets/images/projects/project-4.jpg">
													<span class="zoom">
